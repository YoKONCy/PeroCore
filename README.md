...
- [ ] **V3.1**: 增强视觉能力 (Screen Vision)，支持实时屏幕理解。
- [ ] **V3.2**: 本地 LLM 深度适配 (GGUF/Llama.cpp)，实现完全离线运行。
- [ ] **V4.0**: "Ghost in the Shell" —— 实现操作系统级的完全接管与自主规划。
...
*   "Touhou Project" 及相关角色版权属于 **上海爱丽丝幻乐团 (Team Shanghai Alice)**。本项目为同人衍生作品。
