...
> **适用范围**：PeroCore-TS 全项目（后端 / 前端 / Electron / Rust 模块）
...
function getActiveWindowTitle_linux(): string {
  ...
  return execSync('xdotool getactivewindow getwindowname').toString().trim()
}

// ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
// @platform DARWIN — 使用 AppleScript 获取活动窗口标题
// ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
function getActiveWindowTitle_darwin(): string {
  const { execSync } = require('node:child_process')
  return execSync('osascript -e \'tell application "System Events" to get name of first process whose frontmost is true\'').toString().trim()
}
```
...
// ✅ 策略模式，各平台实现独立文件
// services/system/activeWindow.ts
...
在 [07_DUAL_DEPLOYMENT.md](./07_DUAL_DEPLOYMENT.md) 中已经定义：
...
*本文档由 Carola 整理，适用于 PeroCore-TS 跨平台开发规范。*
